...
| 🚧 Captura por voz | Fase 2 | Planejado para 2026-09 |
| 🚧 Insights com LLM | Fase 2 | Interpretação natural de linguagem |
...
- **Env vars:** Públicas (`VITE_*`) no repo, privadas (Claude API) em Vercel secrets
